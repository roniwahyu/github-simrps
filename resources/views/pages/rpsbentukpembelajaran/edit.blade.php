...
<?php
    $pageTitle = "Edit Rps Bentuk Pembelajaran"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Edit Rps Bentuk Pembelajaran</div>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-bentuk-holder" class=" ">
                                            <input id="ctrl-bentuk" data-field="bentuk"  value="<?php  echo $data['bentuk']; ?>" type="text" placeholder="Enter Bentuk"  name="bentuk"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
