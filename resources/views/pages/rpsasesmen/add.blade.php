...
<?php
    $pageTitle = "Add New Rps Asesman"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Add New Rps Asesman</div>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-asesmen-holder" class=" ">
                                                <input id="ctrl-asesmen" data-field="asesmen"  value="<?php echo get_value('asesmen') ?>" type="text" placeholder="Enter Asesmen"  name="asesmen"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
