    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center gap-3">
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Rps Cp</div>
                    </div>
                </div>
                <div class="col-auto  " >
                            ...
                            <table class="table table-hover table-striped table-sm text-left">
                                <thead class="table-header ">
                                    <tr>
                                        ...
                                        <th class="td-kode_cp" > Kode Cp</th>
                                        <th class="td-nama_cp" > Nama Cp</th>
                                        <th class="td-deskripsi" > Deskripsi</th>
                                        <th class="td-id_jenis_cp" > Id Jenis Cp</th>
                                ...
                                <tbody class="page-data">
                                    ...
                                    <td class="td-btn">
                                        ...
                                        <a class="dropdown-item record-delete-btn" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal" href="<?php print_link("rpscp/delete/$rec_id"); ?>" >
        ...
        <div class=" mt-3">
            <div class="row align-items-center justify-content-between">    
                <div class="col-md-auto d-flex">    
                    <button data-prompt-msg="Are you sure you want to delete these records?" data-display-style="modal" data-url="<?php print_link("rpscp/delete/{sel_ids}"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
