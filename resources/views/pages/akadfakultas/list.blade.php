...
<?php
    ...
    $pageTitle = "Akad Fakultas"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center gap-3">
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Akad Fakultas</div>
                    </div>
                </div>
                <div class="col-auto  " >
                    <a  class="btn btn-primary btn-block" href="<?php print_link("akadfakultas/add", true) ?>" >
                    <i class="fa fa-plus"></i>                              
                    Add New Akad Fakulta 
                </a>
            </div>
            <div class="col-md-3  " >
...
<div  class="" >
    <div class="container-fluid">
                                    ...
                                    <table class="table table-hover table-striped table-sm text-left">
                                        <thead class="table-header ">
                                            <tr>
                                                ...
                                                <th class="td-" > </th><th class="td-id_fakultas" > Id Fakultas</th>
                                                <th class="td-universitas_id" > Universitas Id</th>
                                                <th class="td-kode_fakultas" > Kode Fakultas</th>
                                                <th class="td-nama_fakultas" > Nama Fakultas</th>
                                        ...
                                        <tbody class="page-data">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-masterdetailbtn">
                                                    <a data-page-id="akadfakultas-detail-page" class="btn btn-sm btn-secondary open-master-detail-page" href="<?php print_link("akadfakultas/masterdetail/$data[id_fakultas]"); ?>">
                                        ...
                                        <td class="td-btn">
                                            ...
                                            <a class="dropdown-item record-delete-btn" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal" href="<?php print_link("akadfakultas/delete/$rec_id"); ?>" >
            ...
            <div class=" mt-3">
                <div class="row align-items-center justify-content-between">    
                    <div class="col-md-auto d-flex">    
                        <button data-prompt-msg="Are you sure you want to delete these records?" data-display-style="modal" data-url="<?php print_link("akadfakultas/delete/{sel_ids}"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
        ...
        <div class="col-12">
            <div class=" ">
                <div id="akadfakultas-detail-page" class="master-detail-page"></div>
            </div>
        </div>
        <?php } ?>
    </div>
