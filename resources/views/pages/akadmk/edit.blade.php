...
<?php
    $pageTitle = "Edit Akad Mk"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Edit Akad Mk</div>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-kode_mk-holder" class=" ">
                                            <input id="ctrl-kode_mk" data-field="kode_mk"  value="<?php  echo $data['kode_mk']; ?>" type="text" placeholder="Enter Kode Mk"  required="" name="kode_mk"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-nm_mk-holder" class=" ">
                                            <input id="ctrl-nm_mk" data-field="nm_mk"  value="<?php  echo $data['nm_mk']; ?>" type="text" placeholder="Enter Nm Mk"  required="" name="nm_mk"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-sks_mk-holder" class=" ">
                                            <input id="ctrl-sks_mk" data-field="sks_mk"  value="<?php  echo $data['sks_mk']; ?>" type="number" placeholder="Enter Sks Mk" step="any"  required="" name="sks_mk"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-sks_tatapmuka-holder" class=" ">
                                            <input id="ctrl-sks_tatapmuka" data-field="sks_tatapmuka"  value="<?php  echo $data['sks_tatapmuka']; ?>" type="number" placeholder="Enter Sks Tatapmuka" step="any"  required="" name="sks_tatapmuka"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-sks_praktikum-holder" class=" ">
                                            <input id="ctrl-sks_praktikum" data-field="sks_praktikum"  value="<?php  echo $data['sks_praktikum']; ?>" type="number" placeholder="Enter Sks Praktikum" step="any"  required="" name="sks_praktikum"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-upload_silabus_mk-holder" class=" ">
                                            <input id="ctrl-upload_silabus_mk" data-field="upload_silabus_mk"  value="<?php  echo $data['upload_silabus_mk']; ?>" type="text" placeholder="Enter Upload Silabus Mk"  required="" name="upload_silabus_mk"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-upload_sap_mk-holder" class=" ">
                                            <input id="ctrl-upload_sap_mk" data-field="upload_sap_mk"  value="<?php  echo $data['upload_sap_mk']; ?>" type="text" placeholder="Enter Upload Sap Mk"  required="" name="upload_sap_mk"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-upload_bahan_mk-holder" class=" ">
                                            <input id="ctrl-upload_bahan_mk" data-field="upload_bahan_mk"  value="<?php  echo $data['upload_bahan_mk']; ?>" type="text" placeholder="Enter Upload Bahan Mk"  required="" name="upload_bahan_mk"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-upload_diktat_mk-holder" class=" ">
                                            <input id="ctrl-upload_diktat_mk" data-field="upload_diktat_mk"  value="<?php  echo $data['upload_diktat_mk']; ?>" type="text" placeholder="Enter Upload Diktat Mk"  required="" name="upload_diktat_mk"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-semester-holder" class=" ">
                                            <input id="ctrl-semester" data-field="semester"  value="<?php  echo $data['semester']; ?>" type="text" placeholder="Enter Semester"  name="semester"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
