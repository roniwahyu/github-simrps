...
<div  class="" >
                                        ...
                                        <tbody class="page-data">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-masterdetailbtn">
                                                    <a data-page-id="akadmk-detail-page" class="btn btn-sm btn-secondary open-master-detail-page" href="<?php print_link("akadmk/masterdetail/$data[id]"); ?>">
    ...
    <div class="col-12">
        <div class=" ">
            <div id="akadmk-detail-page" class="master-detail-page"></div>
        </div>
    </div>
    <?php } ?>
</div>
