...
<?php
    $pageTitle = "Edit Akad Kurikulum"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Edit Akad Kurikulum</div>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-kode_kurikulum-holder" class=" ">
                                            <input id="ctrl-kode_kurikulum" data-field="kode_kurikulum"  value="<?php  echo $data['kode_kurikulum']; ?>" type="text" placeholder="Enter Kode Kurikulum"  required="" name="kode_kurikulum"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-nm_kurikulum-holder" class=" ">
                                            <input id="ctrl-nm_kurikulum" data-field="nm_kurikulum"  value="<?php  echo $data['nm_kurikulum']; ?>" type="text" placeholder="Enter Nm Kurikulum"  required="" name="nm_kurikulum"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
