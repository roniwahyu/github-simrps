...
<?php
    $pageTitle = "Edit Rps Pustaka Rp"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Edit Rps Pustaka Rp</div>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-no_urut-holder" class=" ">
                                            <input id="ctrl-no_urut" data-field="no_urut"  value="<?php  echo $data['no_urut']; ?>" type="number" placeholder="Enter No Urut" step="any"  name="no_urut"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-pustaka-holder" class=" ">
                                            <textarea placeholder="Enter Pustaka" id="ctrl-pustaka" data-field="pustaka"  rows="5" name="pustaka" class=" form-control"><?php  echo $data['pustaka']; ?></textarea>
