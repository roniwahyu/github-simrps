...
<?php
    $pageTitle = "Edit Akad Dosen"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Edit Akad Dosen</div>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-nidn-holder" class=" ">
                                            <input id="ctrl-nidn" data-field="nidn"  value="<?php  echo $data['nidn']; ?>" type="text" placeholder="Enter Nidn"  required="" name="nidn"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-id_prodi-holder" class=" ">
                                            <input id="ctrl-id_prodi" data-field="id_prodi"  value="<?php  echo $data['id_prodi']; ?>" type="number" placeholder="Enter Id Prodi" step="any"  name="id_prodi"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-nama_lengkap-holder" class=" ">
                                            <input id="ctrl-nama_lengkap" data-field="nama_lengkap"  value="<?php  echo $data['nama_lengkap']; ?>" type="text" placeholder="Enter Nama Lengkap"  name="nama_lengkap"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-nama_lengkap_gelar-holder" class=" ">
                                            <input id="ctrl-nama_lengkap_gelar" data-field="nama_lengkap_gelar"  value="<?php  echo $data['nama_lengkap_gelar']; ?>" type="text" placeholder="Enter Nama Lengkap Gelar"  name="nama_lengkap_gelar"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-id_jabfung-holder" class=" ">
                                            <input id="ctrl-id_jabfung" data-field="id_jabfung"  value="<?php  echo $data['id_jabfung']; ?>" type="number" placeholder="Enter Id Jabfung" step="any"  name="id_jabfung"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-id_user-holder" class=" ">
                                            <input id="ctrl-id_user" data-field="id_user"  value="<?php  echo $data['id_user']; ?>" type="number" placeholder="Enter Id User" step="any"  name="id_user"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
