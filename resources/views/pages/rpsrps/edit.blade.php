...
<?php
    $pageTitle = "Edit Rps Rp"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Edit Rps Rp</div>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-id_otoritas1-holder" class=" ">
                                            <input id="ctrl-id_otoritas1" data-field="id_otoritas1"  value="<?php  echo $data['id_otoritas1']; ?>" type="number" placeholder="Enter Id Otoritas1" step="any"  name="id_otoritas1"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-id_otoritas2-holder" class=" ">
                                            <input id="ctrl-id_otoritas2" data-field="id_otoritas2"  value="<?php  echo $data['id_otoritas2']; ?>" type="number" placeholder="Enter Id Otoritas2" step="any"  name="id_otoritas2"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-deskripsi_rps-holder" class=" ">
                                            <textarea placeholder="Enter Deskripsi Rps" id="ctrl-deskripsi_rps" data-field="deskripsi_rps"  rows="5" name="deskripsi_rps" class=" form-control"><?php  echo $data['deskripsi_rps']; ?></textarea>
