    ...
    <div class="master-detail-page card">
        ...
        <div class="p-2">
            ...
            <li class="nav-item">
                <a data-bs-toggle="tab" href="#rpscprps_<?php echo $page_id ?>" class="nav-link ">
                CPL
            </a>
        </li>
        <li class="nav-item">
            <a data-bs-toggle="tab" href="#rpspustakarps_<?php echo $page_id ?>" class="nav-link ">
            Pustaka
        </a>
    </li>
</ul>
...
<div class="tab-pane fade show " id="rpscprps_<?php echo $page_id ?>" role="tabpanel">
<div class=" ">
    <?php
        $params = ['id_rps' => $rec_id,'show_header' => false]; //new query param
        $query = array_merge(request()->query(), $params);
        $queryParams = http_build_query($query);
        $url = url("rpscprps/index/id_rps/$rec_id?$queryParams");
    ?>
    <div class="ajax-inline-page" data-url="{{ $url }}" >
        <div class="ajax-page-load-indicator">
            <div class="text-center d-flex justify-content-center load-indicator">
...
<div class="tab-pane fade show " id="rpspustakarps_<?php echo $page_id ?>" role="tabpanel">
<div class=" ">
    <?php
        $params = ['id_rps' => $rec_id,'show_header' => false]; //new query param
        $query = array_merge(request()->query(), $params);
        $queryParams = http_build_query($query);
        $url = url("rpspustakarps/index/id_rps/$rec_id?$queryParams");
    ?>
    <div class="ajax-inline-page" data-url="{{ $url }}" >
        <div class="ajax-page-load-indicator">
            <div class="text-center d-flex justify-content-center load-indicator">
