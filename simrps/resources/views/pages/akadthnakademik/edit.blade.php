...
<?php
    $pageTitle = "Edit Akad Thn Akademik"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Edit Akad Thn Akademik</div>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-semester_periode-holder" class=" ">
                                            <input id="ctrl-semester_periode" data-field="semester_periode"  value="<?php  echo $data['semester_periode']; ?>" type="text" placeholder="Enter Semester Periode"  required="" name="semester_periode"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
