...
<?php
    ...
    $pageTitle = "Akad Thn Akademik"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center gap-3">
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Akad Thn Akademik</div>
                    </div>
                </div>
                <div class="col-auto  " >
                    <a  class="btn btn-primary btn-block" href="<?php print_link("akadthnakademik/add", true) ?>" >
                    <i class="fa fa-plus"></i>                              
                    Add New Akad Thn Akademik 
                </a>
            </div>
            <div class="col-md-3  " >
                            ...
                            <table class="table table-hover table-striped table-sm text-left">
                                <thead class="table-header ">
                                    <tr>
                                        ...
                                        <th class="td-id_thn_akademik" > Id Thn Akademik</th>
                                        <th class="td-id_universitas" > Id Universitas</th>
                                        <th class="td-semester_periode" > Semester Periode</th>
                                ...
                                <tbody class="page-data">
                                    ...
                                    <td class="td-btn">
                                        ...
                                        <a class="dropdown-item record-delete-btn" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal" href="<?php print_link("akadthnakademik/delete/$rec_id"); ?>" >
        ...
        <div class=" mt-3">
            <div class="row align-items-center justify-content-between">    
                <div class="col-md-auto d-flex">    
                    <button data-prompt-msg="Are you sure you want to delete these records?" data-display-style="modal" data-url="<?php print_link("akadthnakademik/delete/{sel_ids}"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
