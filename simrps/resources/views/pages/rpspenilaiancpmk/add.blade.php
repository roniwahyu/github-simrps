...
<?php
    $pageTitle = "Add New Rps Penilaian Cpmk"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Add New Rps Penilaian Cpmk</div>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-id_subcpmk-holder" class=" ">
                                                <input id="ctrl-id_subcpmk" data-field="id_subcpmk"  value="<?php echo get_value('id_subcpmk') ?>" type="number" placeholder="Enter Id Subcpmk" step="any"  name="id_subcpmk"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-id_kriteria-holder" class=" ">
                                                <input id="ctrl-id_kriteria" data-field="id_kriteria"  value="<?php echo get_value('id_kriteria') ?>" type="number" placeholder="Enter Id Kriteria" step="any"  name="id_kriteria"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-bobot_prosen-holder" class=" ">
                                                <input id="ctrl-bobot_prosen" data-field="bobot_prosen"  value="<?php echo get_value('bobot_prosen') ?>" type="number" placeholder="Enter Bobot Prosen" step="0.1"  name="bobot_prosen"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
