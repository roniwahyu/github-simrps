...
<?php
    $pageTitle = "Add New Rps Pembahasan Rp"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Add New Rps Pembahasan Rp</div>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-pokok_bahasan-holder" class=" ">
                                                <textarea placeholder="Enter Pokok Bahasan" id="ctrl-pokok_bahasan" data-field="pokok_bahasan"  rows="5" name="pokok_bahasan" class=" form-control"><?php echo get_value('pokok_bahasan') ?></textarea>
