...
<?php
    ...
    $pageTitle = "Akad Mk Syarat"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center gap-3">
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Akad Mk Syarat</div>
                    </div>
                </div>
                <div class="col-auto  " >
                    <a  class="btn btn-primary btn-block" href="<?php print_link("akadmksyarat/add", true) ?>" >
                    <i class="fa fa-plus"></i>                              
                    Add New Akad Mk Syarat 
                </a>
            </div>
            <div class="col-md-3  " >
                            ...
                            <table class="table table-hover table-striped table-sm text-left">
                                <thead class="table-header ">
                                    <tr>
                                        ...
                                        <th class="td-id_siakad_mk_syarat" > Id Siakad Mk Syarat</th>
                                        <th class="td-id_prodi" > Id Prodi</th>
                                        <th class="td-kode_mk_main" > Kode Mk Main</th>
                                        <th class="td-kode_mk_syarat" > Kode Mk Syarat</th>
                                        <th class="td-nil_mk_syarat" > Nil Mk Syarat</th>
                                        <th class="td-nil_angka_mk_syarat" > Nil Angka Mk Syarat</th>
                                        <th class="td-urut_syarat" > Urut Syarat</th>
                                ...
                                <tbody class="page-data">
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-btn">
                                            ...
                                            <a class="dropdown-item record-delete-btn" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal" href="<?php print_link("akadmksyarat/delete/$rec_id"); ?>" >
            ...
            <div class=" mt-3">
                <div class="row align-items-center justify-content-between">    
                    <div class="col-md-auto d-flex">    
                        <button data-prompt-msg="Are you sure you want to delete these records?" data-display-style="modal" data-url="<?php print_link("akadmksyarat/delete/{sel_ids}"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
