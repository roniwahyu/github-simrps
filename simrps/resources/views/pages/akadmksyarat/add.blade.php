...
<?php
    $pageTitle = "Add New Akad Mk Syarat"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Add New Akad Mk Syarat</div>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-id_prodi-holder" class=" ">
                                                <input id="ctrl-id_prodi" data-field="id_prodi"  value="<?php echo get_value('id_prodi') ?>" type="number" placeholder="Enter Id Prodi" step="any"  required="" name="id_prodi"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-kode_mk_main-holder" class=" ">
                                                <input id="ctrl-kode_mk_main" data-field="kode_mk_main"  value="<?php echo get_value('kode_mk_main') ?>" type="text" placeholder="Enter Kode Mk Main"  required="" name="kode_mk_main"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-kode_mk_syarat-holder" class=" ">
                                                <input id="ctrl-kode_mk_syarat" data-field="kode_mk_syarat"  value="<?php echo get_value('kode_mk_syarat') ?>" type="text" placeholder="Enter Kode Mk Syarat"  required="" name="kode_mk_syarat"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-nil_angka_mk_syarat-holder" class=" ">
                                                <input id="ctrl-nil_angka_mk_syarat" data-field="nil_angka_mk_syarat"  value="<?php echo get_value('nil_angka_mk_syarat') ?>" type="number" placeholder="Enter Nil Angka Mk Syarat" step="0.1"  required="" name="nil_angka_mk_syarat"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-urut_syarat-holder" class=" ">
                                                <input id="ctrl-urut_syarat" data-field="urut_syarat"  value="<?php echo get_value('urut_syarat') ?>" type="number" placeholder="Enter Urut Syarat" step="any"  name="urut_syarat"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
