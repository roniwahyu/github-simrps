...
<?php
    $pageTitle = "Edit Rps Sub Cpmk Asesman"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Edit Rps Sub Cpmk Asesman</div>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-id_sub_cpmk-holder" class=" ">
                                            <input id="ctrl-id_sub_cpmk" data-field="id_sub_cpmk"  value="<?php  echo $data['id_sub_cpmk']; ?>" type="number" placeholder="Enter Id Sub Cpmk" step="any"  name="id_sub_cpmk"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-bobot-holder" class=" ">
                                            <input id="ctrl-bobot" data-field="bobot"  value="<?php  echo $data['bobot']; ?>" type="number" placeholder="Enter Bobot" step="0.1"  name="bobot"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-subtotal-holder" class=" ">
                                            <input id="ctrl-subtotal" data-field="subtotal"  value="<?php  echo $data['subtotal']; ?>" type="number" placeholder="Enter Subtotal" step="0.1"  name="subtotal"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
