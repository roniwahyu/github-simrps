...
<?php
    $pageTitle = "Add New Rps Metode Pembelajaran"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Add New Rps Metode Pembelajaran</div>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-metode-holder" class=" ">
                                                <input id="ctrl-metode" data-field="metode"  value="<?php echo get_value('metode') ?>" type="text" placeholder="Enter Metode"  name="metode"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
