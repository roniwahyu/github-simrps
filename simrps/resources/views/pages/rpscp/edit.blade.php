...
<?php
    $pageTitle = "Edit Rps Cp"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Edit Rps Cp</div>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-kode_cp-holder" class=" ">
                                            <input id="ctrl-kode_cp" data-field="kode_cp"  value="<?php  echo $data['kode_cp']; ?>" type="text" placeholder="Enter Kode Cp"  name="kode_cp"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-nama_cp-holder" class=" ">
                                            <textarea placeholder="Enter Nama Cp" id="ctrl-nama_cp" data-field="nama_cp"  rows="5" name="nama_cp" class=" form-control"><?php  echo $data['nama_cp']; ?></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-deskripsi-holder" class=" ">
                                            <textarea placeholder="Enter Deskripsi" id="ctrl-deskripsi" data-field="deskripsi"  rows="5" name="deskripsi" class=" form-control"><?php  echo $data['deskripsi']; ?></textarea>
                                            <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                        </div>
                                    </div>
                                </div>
