...
<?php
    $pageTitle = "Add New Rps Bahan Ajar"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Add New Rps Bahan Ajar</div>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-bahan_ajar-holder" class=" ">
                                                <input id="ctrl-bahan_ajar" data-field="bahan_ajar"  value="<?php echo get_value('bahan_ajar') ?>" type="text" placeholder="Enter Bahan Ajar"  name="bahan_ajar"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
